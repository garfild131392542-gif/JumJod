...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6 pb-8">
      ...
      {/* 3. Dynamic Boards Settings Card */}
      <div className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-2xl p-4 sm:p-6 shadow-xs backdrop-blur-sm space-y-4">
        <div className="flex items-center gap-3 pb-3 border-b border-slate-100 dark:border-slate-800/80">
          ...
          <div>
            <h3 className="text-base font-bold text-slate-800 dark:text-slate-100">
              จัดการบอร์ดและหมวดหมู่ (Board Manager)
            </h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">
              ปรับแต่งบอร์ด โหมดการทำงาน และหมวดหมู่ของคุณเอง
            </p>
          </div>
        </div>
        
        <div className="flex">
          <a href="/settings/boards" className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold bg-slate-900 dark:bg-white text-white dark:text-slate-900 hover:bg-slate-800 dark:hover:bg-slate-100 shadow-sm active:scale-[0.98] transition-all">
            จัดการบอร์ด
          </a>
        </div>
      </div>

      {/* 4. Privacy & Cookie Policy Link (Compact) */}
      <a
        href="/privacy-policy"
        className="group bg-slate-50 dark:bg-slate-900/40 border border-slate-200/60 dark:border-slate-800/60 rounded-xl p-3 flex items-center justify-between gap-3 shadow-xs hover:bg-slate-100 dark:hover:bg-slate-900/80 transition-all active:scale-[0.98]"
      >
        <div className="flex items-center gap-2.5">
          <ShieldCheck className="w-4 h-4 text-slate-400 group-hover:text-amber-500 transition-colors" />
          <span className="text-xs font-semibold text-slate-600 dark:text-slate-300 group-hover:text-slate-900 dark:group-hover:text-slate-100 transition-colors">
            นโยบายความเป็นส่วนตัว & คุกกี้ (Privacy Policy)
          </span>
        </div>
